...
svn co https://github.com/openwrt/packages/trunk/utils/tini feeds/packages/utils/cgroupfs-mount && ln -sf ../../../feeds/packages/utils/tini package/feeds/packages/cgroupfs-mount
cd package/feeds
