...
svn co --force https://github.com/openwrt/branches/openwrt-19.07/utils/coreutils feeds/packages/utils/coreutils && svn revert -R feeds/packages/utils/coreutils
